    ...
    public function index(): Response
    {
        return Inertia::render('Admin/Dashboard', [
            'stats' => [
                ...
                'events_active'  => Event::whereNull('banned_at')->count(),
...
class AdminTemplateController extends Controller
{
    ...
    {
        // Không xóa cứng — chỉ deactivate để events hiện tại không bị broken
        abort_if($template->events()->exists(), 422, 'Template đang được dùng bởi event. Deactivate thay vì xóa.');
...
<template>
    <AdminLayout>
        ...
        <div class="grid grid-cols-5 gap-4 mb-8">
            ...
            <StatCard label="Queue"         :value="stats.queue_size" :color="stats.queue_size > 100 ? 'red' : 'gray'" />
        </div>
